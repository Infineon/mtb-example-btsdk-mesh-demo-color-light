# BLE Mesh Mesh Color Light demo application

## Overview
This application demonstrates a colored light. It implements the Light HSL (Hue, Saturation, and Lightness) Server model.
...
3. It will change the LEDs on the board.
